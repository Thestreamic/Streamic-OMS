...
<section style="margin:40px 0 34px">
  ...
  <div style="display:grid;grid-template-columns:1.25fr .75fr;gap:18px">
    ...
    <div style="display:grid;grid-template-rows:1fr 1fr;gap:18px">
      <a href="articles/2026-04-01-ai-post-production-frameio-workfront-review-approval-workflow.html" style="position:relative;display:block;overflow:hidden;border-radius:20px;min-height:171px;background:#111;text-decoration:none;color:#fff;box-shadow:0 10px 28px rgba(0,0,0,.10)">
        <img src="assets/fallback.jpg" alt="2026-04-01-ai-post-production-frameio-workfront-review-approval-workflow.html" loading="lazy" onerror="this.onerror=null;this.src='assets/fallback.jpg'" style="width:100%;height:100%;object-fit:cover;display:block;opacity:.9">
        <div style="position:absolute;inset:0;background:linear-gradient(to top, rgba(0,0,0,.84) 0%, rgba(0,0,0,.36) 45%, rgba(0,0,0,.10) 100%)"></div>
        <div style="position:absolute;left:0;right:0;bottom:0;padding:18px 18px 16px;z-index:2">
          ...
          <h3 style="margin:0 0 8px;font-family:var(--serif);font-size:clamp(18px,1.7vw,22px);line-height:1.2;color:#fff">-post-production-frameio-workfront-review-approval-workflow</h3>
