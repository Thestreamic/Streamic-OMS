...
MAX_ARTICLES   = 28          # tighter public footprint for quality control
VISIBLE_CAT    = "ai-post-production"
MIN_BODY_SCORE = 70          # stricter editorial threshold for homepage
MIN_WORD_COUNT = 1000
TRUSTED_SOURCES = {"TV Technology","TVBEurope","NewscastStudio","SVG Europe","The Broadcast Bridge","Haivision","Telestream Blog","Harmonic","AWS Media Blog","Vizrt","Ross Video","Avid","EVS","The Streamic Editorial Team"}
LOW_SIGNAL_PATTERNS = ["music video","trailer","student","education","oscar","creature effects","bosnian knight","beginner","budget studio","political campaign","av events"]
...
def is_adsense_ready_article(a):
    title=(a.get("title") or "").lower()
    src=(a.get("source_domain") or a.get("source") or "The Streamic Editorial Team").strip()
    wc=int(a.get("word_count") or 0)
    if wc < MIN_WORD_COUNT:
        return False
    if src not in TRUSTED_SOURCES:
        return False
    if any(p in title for p in LOW_SIGNAL_PATTERNS):
        return False
    return True
...
def nav(active="", base=""):
    ...
    cats = [
        ...
        ("professional-media-systems-guide.html", "Media Systems Guide"),
    ]
...
def footer(base=""):
  ...
  <div class="footer-grid">
    ...
    <div class="footer-col">
      ...
      <a href="{base}professional-media-systems-guide.html">Media Systems Guide</a>
    </div>
    <div class="footer-col">
      <h4>Site</h4>
...
def sitemap(arts):
    ...
    statics = [
        ...
        ("howto.html","weekly","0.85"),("post-production-workflows.html","weekly","0.90"),("professional-media-systems-guide.html","weekly","0.85"),("broadcast-systems-hub.html","monthly","0.20"),
...
<a href="featured.html" style="color:var(--blue)">Return to homepage &rarr;</a></p>
    ...
    # Media systems guide + legacy redirect
    guide_src = os.path.join(DOCS, "professional-media-systems-guide.html")
    if not os.path.exists(guide_src):
        _guide_placeholder = f"""{head("Professional Media Systems Guide — The Streamic",
            "Source-grounded vendor guides for broadcast and media operations.",
            f"{BASE_URL}/professional-media-systems-guide.html",
            robots="noindex,follow")}
<body>{nav("professional-media-systems-guide.html")}<main><div class="w" style="padding:80px 0 120px;text-align:center">
<h1 style="font-family:var(--serif);font-size:28px;margin-bottom:16px">Professional Media Systems Guide</h1>
<p style="color:var(--ink3)">Run <code>python3 scripts/generate_vendor_hub.py</code> to build the source-grounded vendor guide.</p>
<p><a href="featured.html" style="color:var(--blue)">Return to homepage &rarr;</a></p>
</div></main>{footer()}</body></html>"""
        w(guide_src, _guide_placeholder)
    legacy_redirect = f'''<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta http-equiv="refresh" content="0; url={BASE_URL}/professional-media-systems-guide.html"><link rel="canonical" href="{BASE_URL}/professional-media-systems-guide.html"><meta name="robots" content="noindex,follow"><title>Redirecting…</title></head><body><p>Redirecting to <a href="{BASE_URL}/professional-media-systems-guide.html">Professional Media Systems Guide</a>.</p></body></html>'''
    w(os.path.join(DOCS, "broadcast-systems-hub.html"), legacy_redirect)
    print("  &#10003; static pages + media systems guide placeholder/redirect")
