...
<div id="{cat_anchor}" style="margin-top:52px;padding-top:20px;border-top:2px solid var(--ink)">
  ...
  <p style="font-size:13px;color:var(--ink4);margin:0 0 32px">Engineering briefs for {cat} systems used in professional broadcast environments</p>
</div>"""
            prev_cat = cat
        ...
        # Wrap each vendor block in a styled card div
        content_html += f"""
<div id="{slug}" style="background:var(--white);border:1px solid var(--line);border-radius:12px;padding:28px 32px;margin-bottom:24px">
...
<head>
  ...
  <title>Broadcast Systems Integration Hub: Avid, EVS, Vizrt, Grass Valley &amp; More | The Streamic</title>
