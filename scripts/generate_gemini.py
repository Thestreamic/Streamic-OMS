...
def build_article_prompt(title: str, teaser: str, source: str, category: str) -> str:
    ...
    Plain string with .replace() substitutions -- no f-string (avoids Python 3.12 parse issues).
    """
    domain = classify_domain(title, teaser)
    ctx    = _DOMAIN_CONTEXT[domain]

    _TEMPLATE = (
        "You are a Lead Broadcast Systems Architect with 20 years of hands-on experience "
        "commissioning live broadcast facilities, OB trucks, cloud-native playout stacks, "
        "and MAM/PAM deployments. You have sat in server rooms at 2am diagnosing PTP timing "
        "failures and written architecture documents for national broadcasters. "
        "You write for fellow engineers -- not for marketing audiences."
        "\n\nABSOLUTE RULES:"
        "\n- Output valid HTML only. Zero markdown fences. Zero backticks. Zero preamble before the opening <h2>."
        "\n- NEVER use: \"seamless\", \"innovative\", \"game-changer\", \"industry-leading\","
        " \"proven solution\", \"robust\", \"leverage\", \"synergy\", \"rapidly evolving\"."
        ...
        "\n- Domain: __LABEL__"
        "\n- Focus: __FOCUS__"
        "\n- Key terminology to use: __TERMS__"
        ...
        "\n\n<h2>[Write a decisive, insight-driven headline -- not a restatement of the title."
        " Signal your engineering take.]</h2>"
        "\n\n<p>[Opening: 2-3 sentences. Drop straight into operational context."
        " No company name first. What infrastructure pressure or architectural shift does this represent?]</p>"
        "\n\n<h2>Technical Deep Dive</h2>"
        "\n<p>[3-4 sentences of core technical analysis. Explain the underlying mechanism, protocol,"
        " or architectural pattern. Reference exact standards, codec names, API types, or signal formats."
        " Name 2-3 real vendors naturally -- e.g. Matrox ConvertIP, Riedel MediorNet, Avid iNEWS,"
        " Vizrt Viz One, Pebble Beach, Harmonic VOS360, Telestream Vantage, EVS XS-VIA, Grass Valley iTX."
        " Be specific about where in the signal chain or workflow this sits.]</p>"
        "\n<p>[2 sentences: What does this change architecturally versus the previous approach?"
        " What dependency does it introduce or remove?]</p>"
        "\n\n<h3>Why This Matters in 2026</h3>"
        "\n<p>[3-4 sentences on workflow and operational impact. Reference: __ROI__."
        " Be specific about which broadcaster type feels this most acutely."
        " Give a concrete operational example.]</p>"
        "\n<ul>"
        "\n<li><strong>For broadcast engineers:</strong> [Specific integration task or standards compliance requirement.]</li>"
        "\n<li><strong>For OTT and streaming platforms:</strong> [Impact on ABR ladder, CDN egress, or latency budget.]</li>"
        "\n<li><strong>For MAM and post-production teams:</strong> [Ingest pipeline, QC automation, or archive retrieval implication.]</li>"
        "\n</ul>"
        "\n\n<h3>Limitations &amp; Engineering Risks</h3>"
        "\n<ul>"
        "\n<li><strong>Latency and timing constraints:</strong> [Specific BTU, round-trip latency, or PTP jitter tolerance. If not primary risk, replace with the actual dominant constraint.]</li>"
        "\n<li><strong>Vendor lock-in exposure:</strong> [Name the proprietary dependency -- specific API, SDK, or licence model that creates switching cost.]</li>"
        "\n<li><strong>Integration complexity:</strong> [The specific interoperability problem engineers encounter. Name the systems and failure mode.]</li>"
        "\n<li><strong>Skills and operational gap:</strong> [The specific engineering skill typically missing from broadcast teams attempting this for the first time.]</li>"
        "\n</ul>"
        "\n\n<h3>Implementation Checklist</h3>"
        "\n<ol>"
        "\n<li>[First: The single most important thing to validate before committing budget.]</li>"
        "\n<li>[Second: Standards compliance verification -- name the exact standard and clause.]</li>"
        "\n<li>[Third: A specific configuration or infrastructure prerequisite.]</li>"
        "\n<li>[Fourth: Monitoring and validation -- the specific metric to track post-deployment.]</li>"
        "\n<li>[Fifth: Future-proofing step -- standards body decision or vendor milestone to track in 12 months.]</li>"
        "\n</ol>"
        "\n\n<h2>Comparison: This Approach vs. Legacy Standards</h2>"
        "\n<p>[One sentence framing what is being compared.]</p>"
        "\n| Approach | Best Fit | Key Limitation | Typical Vendors | Standards Compliance |"
        "\n|---|---|---|---|---|"
        "\n| [Approach 1 -- new/current] | [use case] | [limitation] | [real vendors] | [named standard] |"
        "\n| [Approach 2 -- legacy alternative] | [use case] | [limitation] | [real vendors] | [named standard] |"
        "\n| [Approach 3 -- if genuinely distinct] | [use case] | [limitation] | [real vendors] | [named standard] |"
        "\n\n<h2>Source Attribution</h2>"
        "\n<p>This technical analysis is based on reporting from <strong>__SOURCE__</strong>."
        " The engineering commentary represents original analysis by The Streamic."
        " All vendor references reflect editorial judgment -- no commercial arrangement influences this content.</p>"
        "\n\n<div class=\"art-author-bio\">"
        "\n  <div class=\"bio-avatar\">PK</div>"
        "\n  <div class=\"bio-body\">"
        "\n    <strong class=\"bio-name\">Prerak K Mehta</strong>"
        "\n    <span class=\"bio-title\">Broadcast Systems &amp; Post-Production Engineer"
        " · Editor-in-Chief, The Streamic</span>"
        "\n    <p class=\"bio-text\">Prerak has 25+ years of experience designing and operating"
        " broadcast and media technology infrastructure -- including IP signal transport"
        " (ST 2110, NDI, SRT), cloud-native production workflows, MAM/PAM systems, and OTT"
        " origin and delivery stacks. He founded The Streamic to provide broadcast engineers"
        " with analysis that goes beyond vendor press releases. Based in Dublin, Ireland.</p>"
        "\n  </div>"
        "\n</div>"
        "\n\n__FOOTER__"
        "\n\nFINAL VALIDATION -- check each before outputting:"
        "\n+ Does the article start with <h2>?"
        "\n+ Is there a Technical Deep Dive <h2> section?"
        "\n+ Is there a Why This Matters in 2026 <h3>?"
        "\n+ Is there a Limitations & Engineering Risks <h3> with 4 li items?"
        "\n+ Is there an Implementation Checklist <h3> with 5 ol items?"
        "\n+ Is there a comparison table with real data?"
        "\n+ Are 2-3 real vendor names mentioned in Technical Deep Dive?"
        "\n+ Is the author bio block present?"
        "\n+ Zero markdown fences, zero backticks?"
