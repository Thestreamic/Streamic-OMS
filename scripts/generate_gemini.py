...
def build_article_prompt(title: str, teaser: str, source: str, category: str) -> str:
    ...
    _TEMPLATE = (
        ...
        "\n    <span class=\"bio-title\">Founder, The Streamic &middot; Dublin, Ireland"
        "</span>"
        "\n    <p class=\"bio-text\">Broadcast technology professional with total 25+ years of IT and 20 years of Med"
