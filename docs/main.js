...
```html
<form action="https://formspree.io/f/xdapdday" method="POST">
...
<script>
  ...
  formspree('initForm', { formElement: '#my-form', formId: 'xdapdday' });
</script>
...
initForm({ formElement: '#my-form', formId: 'xdapdday' });
```
...
function ContactForm() {
  const [state, handleSubmit] = useForm('xdapdday');
